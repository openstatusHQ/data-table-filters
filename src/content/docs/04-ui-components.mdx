...
faq:
  - question: "What UI components are included?"
    answer: "The library provides DataTableInfinite (infinite scroll table), DataTableFilterControls (sidebar filters with accordions), DataTableFilterCommand (command palette with filter syntax), and DataTableSheetDetails (row detail drawer)."
