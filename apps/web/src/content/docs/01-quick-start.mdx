...
faq:
  - question: "How do I install data-table-filters?"
    answer: "Run `npx shadcn@latest add https://data-table.openstatus.dev/r/data-table.json` to install the core block with 58 files, including the table engine, memory store adapter, and all 4 filter types."
