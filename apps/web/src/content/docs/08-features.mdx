...
faq:
  - question: "What keyboard shortcuts are available?"
    answer: "Supported shortcuts include Cmd+K (command palette), Cmd+B (toggle sidebar), Cmd+U (clear filters), Cmd+J (toggle live mode), Esc (close dialogs), Cmd+. (toggle debug panel), and Cmd+Shift+X (deselect all rows)."
